    ...
    <div className="container">
      ...
      <nav className="navbar">
        ...
        <div className="nav-links">
          {/* Redireccionado al menú administrador */}
          <Link to="/pagosa" className="nav-link">Pagos</Link>
          <Link to="/multasa" className="nav-link">Multas</Link> {/* Redirige a multasu.jsx */}
      ...
      <div className="buttons-container">
        <div className="menu-item">
          ...
          <Link to="/pagosa" className="menu-button">Pagos</Link> {/* Redirige a pagosu.jsx */}
        </div>

        <div className="menu-item">
          <img src="src/Imagenes/multa.png" alt="Multas" className="menu-image" />
          <Link to="/multasa" className="menu-button">Multas</Link> {/* Redirige a multasu.jsx */}
        </div>

        <div className="menu-item">
          <img src="src/Imagenes/porton.png" alt="Portones" className="menu-image" />
          <Link to="/portonesa" className="menu-button">Portones</Link> {/* Redirige a portonesu.jsx */}
        </div>

        {/* Nuevo botón para Gestión de Usuarios con la imagen gesusu.png */}
        <div className="menu-item">
          <img src="src/Imagenes/gesusu.png" alt="Gestión de Usuarios" className="menu-image" />
          <Link to="/gesusua" className="menu-button">Gestión de Usuarios</Link> {/* Redirige a gesusua.jsx */}
        </div>
      </div>
    </div>
  );
